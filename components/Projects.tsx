const companies = [
  {
    ...
    role: "CEO",
    description:
      "A digital innovation company focused on automation, design, and business growth. Builds custom web and app solutions, integrates AI chatbots, and manages SEO for clients.",
  ...
  },
  {
    ...
    role: "CEO",
    description:
      "A fintech education and automation brand. Creates AI-based investment dashboards and tools for traders and investors. Focuses on data-driven finance and wealth growth automation.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {companies.map((company, index) => {
            const colors = [
              { bg: 'from-blue-500/20 to-cyan-500/20', border: 'border-blue-400/50', text: 'text-blue-300', link: 'text-blue-300 hover:text-blue-200', tag: 'border-blue-400/50 text-blue-300' },
              { bg: 'from-green-500/20 to-emerald-500/20', border: 'border-green-400/50', text: 'text-green-300', link: 'text-green-300 hover:text-green-200', tag: 'border-green-400/50 text-green-300' },
              { bg: 'from-purple-500/20 to-pink-500/20', border: 'border-purple-400/50', text: 'text-purple-300', link: 'text-purple-300 hover:text-purple-200', tag: 'border-purple-400/50 text-purple-300' },
            ];
              ...
              >
                ...
                {company.website && (
                  <a
                    ...
                    className={`inline-block mb-4 ${colorScheme.link} font-medium transition-colors group/link`}
                  >
                ...
                <div className="flex flex-wrap gap-2 pt-4 border-t border-gray-700/50">
                  {company.industries.map((industry, industryIndex) => (
                    <span
                      key={industryIndex}
                      className={`px-3 py-1.5 bg-gray-800/50 text-gray-200 border ${colorScheme.tag} rounded-full text-xs md:text-sm font-medium hover:opacity-80 transition-opacity`}
                    >
                      {industry}
                    </span>
                  ))}
